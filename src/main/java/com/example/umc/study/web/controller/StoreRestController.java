...
public class StoreRestController {
    ...
    public ApiResponse<StoreResponseDTO.MissionPreViewListDTO> getMemberMissionList(@ExistStore @PathVariable(name = "memberId") Long memberId, @RequestParam(name = "page") Integer page){
        storeQueryService.getMemberMissionList(memberId,page);
        return null;
    }
    ...
    public ApiResponse<StoreResponseDTO.ReviewPreViewListDTO> getMemberReviewList(@ExistStore @PathVariable(name = "memberId") Long memberId, @RequestParam(name = "page") Integer page){
        storeQueryService.getMemberReviewList(memberId,page);
        return null;
    }
